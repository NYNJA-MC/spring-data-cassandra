...
'''
			sh 'mvn --settings settings.xml clean  deploy -DskipTests=true -DaltSnapshotDeploymentRepository=nynjagroup.jfrog.io::default::https://nynjagroup.jfrog.io/nynjagroup/libs-snapshot-local'
		    }
