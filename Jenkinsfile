...
'''
			sh 'mvn --settings settings.xml clean install deploy -DskipTests=true -DaltSnapshotDeploymentRepository=nynjagroup.jfrog.io::https://nynjagroup.jfrog.io/nynjagroup/libs-snapshot-local'
		    }
