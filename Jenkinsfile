...
'''
              sh 'mvn --settings settings.xml clean deploy -DskipTests=true -DaltReleaseDeploymentRepository=nynjagroup.jfrog.io-libs-release::default::https://nynjagroup.jfrog.io/nynjagroup/libs-release'
            }
