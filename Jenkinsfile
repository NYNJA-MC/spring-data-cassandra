...
'''
              sh 'mvn --settings settings.xml clean deploy -DskipTests=true -DaltReleaseDeploymentRepository=nynjagroup.jfrog.io::default::https://nynjagroup.jfrog.io/nynjagroup/libs-release'
            }
