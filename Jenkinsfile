    ...
    stage('Build') {
      ...
      steps {
        container('mvn') {
			...
			sh """export SETTINGS='<?xml version="1.0" encoding="UTF-8"?><settings xmlns="http://maven.apache.org/SETTINGS/1.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/SETTINGS/1.0.0 http://maven.apache.org/xsd/settings-1.0.0.xsd"> <servers> <server> <id>nynjagroup.jfrog.io</id> <username>${USER}</username> <password>${PASS}</password> </server> <server> <id>nynjagroup.jfrog.io-libs-release</id> <username>${USER}</username> <password>${PASS}</password> </server> </servers> <profiles> <profile> <id>nynja</id> <repositories> <repository> <id>nynjagroup.jfrog.io</id> <url>https://nynjagroup.jfrog.io/nynjagroup</url> </repository> <repository> <id>nynjagroup.jfrog.io-libs-release</id> <name>libs-release</name> <url>https://nynjagroup.jfrog.io/nynjagroup/libs-release</url> </repository> </repositories> </profile> </profiles> <activeProfiles> <activeProfile>nynja</activeProfile> </activeProfiles> </settings>'"""
